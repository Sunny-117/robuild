...
## robuild 中 dts 的工作原理 {#how-it-works}
...
### 启用 `isolatedDeclarations` {#isolated-declarations}
...
### 未启用 `isolatedDeclarations` {#without-isolated-declarations}
...
- [TypeScript 支持](../guide/typescript.md) - TypeScript 配置详解
