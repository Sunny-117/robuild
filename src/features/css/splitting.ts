...
import type { CssOptions } from './index'
import { defaultCssBundleName } from './index'
 ...
 */
export function createCssCodeSplitPlugin(
  config: Pick<Required<CssOptions>, 'splitting' | 'fileName'>,
): Plugin | undefined {
