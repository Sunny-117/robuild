...
- [x] **目标环境配置** - 支持 ES 版本目标如 `es2015`, `esnext` 等 ✅ [文档](docs/guide/cli-config-enhancements.md#目标环境配置)
- [x] **外部依赖配置** - 更灵活的 `external` 和 `noExternal` 配置 ✅ [文档](docs/guide/cli-config-enhancements.md#外部依赖配置)
